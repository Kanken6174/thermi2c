...
int MLX90640::mlx90640_TriggerMeasurement(uint8_t slaveAddr)
{
    int error = 1;
    uint16_t ctrlReg;
...
int MLX90640::mlx90640_ExtractParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int error = 0;
...
void MLX90640::mlx90640_CalculateTo(uint16_t *frameData, const paramsMLX90640 *params, float emissivity, float tr, float *result)
{
    float vdd;
    float ta;
    float ta4;
...
void MLX90640::mlx90640_GetImage(uint16_t *frameData, const paramsMLX90640 *params)
{
    float vdd;
    float ta;
    float gain;
...
float MLX90640::mlx90640_GetVdd(uint16_t *frameData, const paramsMLX90640 *params)
{
    float vdd;
...
float MLX90640::mlx90640_GetTa(uint16_t *frameData, const paramsMLX90640 *params)
{
    int16_t ptat;
    float ptatArt;
    float vdd;
...
//------------------------------------------------------------------------------
void MLX90640::mlx90640_BadPixelsCorrection(uint16_t *pixels, float *to, int mode, paramsMLX90640 *params)
{
    float ap[4];
    uint8_t pix;
    uint8_t line;
...
void MLX90640::ExtractVDDParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int8_t kVdd;
    int16_t vdd25;
...
void MLX90640::ExtractPTATParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    float KvPTAT;
    float KtPTAT;
    int16_t vPTAT25;
...
void MLX90640::ExtractGainParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
...
void MLX90640::ExtractTgcParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
...
void MLX90640::ExtractResolutionParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
...
void MLX90640::ExtractKsTaParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
...
void MLX90640::ExtractKsToParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int32_t KsToScale;
    int8_t step;
...
void MLX90640::ExtractAlphaParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int accRow[24];
    int accColumn[32];
    int p = 0;
...
void MLX90640::ExtractOffsetParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int occRow[24];
    int occColumn[32];
    int p = 0;
...
void MLX90640::ExtractKtaPixelParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int p = 0;
    int8_t KtaRC[4];
    uint8_t ktaScale1;
...
void MLX90640::ExtractKvPixelParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    int p = 0;
    int8_t KvT[4];
    int8_t KvRoCo;
...
void MLX90640::ExtractCPParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    float alphaSP[2];
    int16_t offsetSP[2];
    float cpKv;
...
void MLX90640::ExtractCILCParameters(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    float ilChessC[3];
...
int MLX90640::ExtractDeviatingPixels(uint16_t *eeData, paramsMLX90640 *MLX90640)
{
    uint16_t pixCnt = 0;
